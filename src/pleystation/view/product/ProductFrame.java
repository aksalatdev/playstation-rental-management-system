...
public class ProductFrame extends javax.swing.JFrame {
    ...
    private List<ProductModel> productData = null;
     ...
     */
    public ProductFrame(UserLevel level) {
        initComponents();
        ...
        if (level == UserLevel.Kasir) {
            btnNewData.setVisible(false);
        }
        
        productData = controller.getAllData(currentPage);
        productData.forEach((productModel) -> {
            tableModel.addRow(productModel.toObjects());
        });
    }
    ...
    private void initComponents() {
        ...
        txtSearch.setText("Cari data barang...");
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Barang", "Kategori", "Nama Barang", "Ketersediaan", "Harga Sewa"
            }
        ) {
    ...
    private void txtSearchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSearchFocusGained
        if (txtSearch.getText().equals("Cari data barang...")) {
            txtSearch.setText("");
        }
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
        if (level == UserLevel.Admin) {
            new ProductDetailsDialog(this, 
                    controller, 
                    productData.get(tblData.getSelectedRow()).getProductId()
            ).setVisible(true);
            repopulateTable();
        }
    ...
    private void btnNewDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewDataActionPerformed
        new ProductDetailsDialog(this, controller).setVisible(true);
        repopulateTable();
    }//GEN-LAST:event_btnNewDataActionPerformed

    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        if (txtSearch.getText().equals("") || txtSearch.getText().equals("Cari data barang...")) {
            repopulateTable();
            return;
        }
        ...
        productData = controller.searchData(txtSearch.getText(), 1);
        productData.forEach((userModel) -> {
