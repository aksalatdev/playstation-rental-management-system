...
public class UserFrame extends javax.swing.JFrame {
    ...
    public UserFrame() {
        ...
        userData = controller.getAllData(currentPage);
        userData.forEach((userModel) -> {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Data Pengguna");
        ...
        txtSearch.setText("Cari data pengguna...");
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Pengguna", "Nama Lengkap", "Hak Akses"
            }
        ) {
    ...
    private void txtSearchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSearchFocusGained
        if (txtSearch.getText().equals("Cari data pengguna...")) {
            txtSearch.setText("");
        }
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
        new UserDetailsDialog(this, 
                controller, 
                userData.get(tblData.getSelectedRow()).getUsername()
        ).setVisible(true);
        repopulateTable();
    }//GEN-LAST:event_tblDataMouseClicked

    private void btnNewDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewDataActionPerformed
        new UserDetailsDialog(this, controller).setVisible(true);
        repopulateTable();
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        if (txtSearch.getText().equals("") || txtSearch.getText().equals("Cari data pengguna...")) {
            repopulateTable();
            return;
        }
        ...
        userData = controller.searchData(txtSearch.getText(), 1);
        userData.forEach((userModel) -> {
            tableModel.addRow(userModel.toObjects());
        });
